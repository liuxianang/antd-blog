...
<template>
    ...
    <div v-if="this.$store.state.themeObj.user_start!=0" class="footBack footBackQian">
        <div class="footer-img"
             :style="{background:this.$store.state.themeObj.bottom_img?'url('+this.$store.state.themeObj.bottom_img+') no-repeat 50%':'url(assets/img/footer01.png) no-repeat 50%'}">
        </div>
        <div class="fcontainer">
            ...
            <p>
                © 2018 <a href="#">Mango Ya</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme
                By <a href="https://diygod.me/" target="_blank">diygod.me</a>. 京ICP备17071595号-1.
            </p>
            <p>
                <span>Made with</span> <img class="fheart" src="../../assets/img/heart02.png"/> <span>by Aimee.</span>
            </p>
        </div>
    </div>
    <!-- Qinlh的 -->
    <div v-else class="footBack footBackHui">
        <div class="footer-img">
            <img :src="this.$store.state.themeObj.bottom_img?this.$store.state.themeObj.bottom_img:'assets/img/footer01.png'"
                 alt="">
        </div>
        <div class="fcontainer">
            <p>
            ...
            <p>
                © 2018 <a href="#">QinlhBlog</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme
                By <a href="https://diygod.me/" target="_blank">diygod.me</a>. 京ICP备17071595号-1.
            </p>
            <p>
                <span>Made with</span> <img class="fheart" src="assets/img/heart02.png"/> <span>by Qinlh.</span>
            </p>
        </div>
    </div>
...
<script>
    export default {
        data() { //选项 / 数据
            return {
                footBg: "url(assets/img/footer01.png) no-repeat 50%",//底部图片
                longTime: '',
            }
        },
        methods: { //事件处理器
            runTime: function () {//运行倒计时
                var that = this;
                var oldTime =new Date('2019/12/01 00:00:00');
