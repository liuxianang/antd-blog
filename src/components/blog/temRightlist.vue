...
<template>
    <div class="rightlistBox">
        <section >
            <div class="r1-head">
                <img :src="require('@/assets/img/headtou.jpg')" alt="">
            ...
            <div class="r1-body">
                ...
                <div class="catch-me" >
                    <div class="">
                        <a-tooltip  class="item"  content="Github" placement="top" >
                            <a  :href="catchMeObj[isAimee].git" target="_blank" ><a-icon type="github" /></a>
                        </a-tooltip>
                        <a-tooltip class="item" effect="dark" content="QQ" placement="top">
                            <a  :href="catchMeObj[isAimee].qq" target="_blank"><a-icon type="qq-circle" theme="filled" /></a>
                        </a-tooltip>
                        <a-tooltip class="item" effect="dark" content="微博" placement="top">
                            <a :href="catchMeObj[isAimee].sina" target="_blank"><a-icon type="weibo-circle" /> </a>
                        </a-tooltip>
                    </div>
                    <div class="">
                        <a-tooltip class="item" effect="dark" content="微信" placement="top">
                            <a :href="catchMeObj[isAimee].wechat" target="_blank"><a-icon type="wechat" /></a>
                        </a-tooltip>
                        <a-tooltip class="item" effect="dark" content="CSDN" placement="top">
                            <a :href="catchMeObj[isAimee].csdn" target="_blank"><i class="">C</i></a>
                        </a-tooltip>
                        <a-tooltip class="item" effect="dark" content="简历" placement="top">
                            <a :href="catchMeObj[isAimee].job" target="_blank"><a-icon type="file-word" /></a>
                        </a-tooltip>
                        <a-tooltip class="item" effect="dark" content="更多" placement="top">
                            <a href="#/Aboutme" ><a-icon type="small-dash" /> </a>
                        </a-tooltip>
                    </div>
                </div>
            </div>
...
<script>
    import API from '../../api/api_blogComments'
    export default {
        data() { //选项 / 数据
            return {
                fixDo:false,
        ...
        created() { //生命周期函数
            ...
            //查询浏览量最多的10篇文章数据
            this.$route.query
            API.getblogCommentsid({id:this.$route.query.aid}).then(res => {
                console.log(res);
                //获取详情接口
                that.artCommentList = res.data

            })
            API.getblogweiguanid({id:this.$route.query.aid}).then(res => {
                console.log(res);
                //获取详情接口
